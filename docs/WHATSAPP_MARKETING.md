...
Aucune migration SQL ni nouvelle variable d’environnement. La création de nouveaux modèles depuis AutoGet reste limitée au texte ; créer les modèles à image/boutons dans WhatsApp Manager puis actualiser AutoGet. Valider un envoi réel sur un numéro de test avant une campagne. Structure API : https://whatsapp.github.io/WhatsApp-Nodejs-SDK/api-reference/types/TemplateObject/
